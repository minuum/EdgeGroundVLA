        ...
        with gr.Row(equal_height=False):
          ...
          with gr.Column(scale=1):
            gr.Markdown(
                ...
                "```\n\n"
                "**바스켓 배치 기준:**  \n"
                "- `center_straight` — 로봇 **정면**, 각도 0°  \n"
                "- `left_diagonal` — 로봇 **좌측 대각선** ~30~45°  \n"
                "- `right_diagonal` ★ — 로봇 **우측 대각선** ~30~45°  \n"
                "- `center_curve` — 정면에 두되 **로봇 시작 자세를 살짝 틀어** S자 유도"
            )
