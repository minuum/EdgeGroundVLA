#!/usr/bin/env python3
"""
plan_20260623_area_delta_proximity_feature.md §2 — closed_loop_eval_lstm_pg2.py를
area_delta feature 추가 버전(stage2_v2_lstm_areadelta)으로 재실행하는 복제본.
none 모드만 평가(area_delta ablation은 hidden state 없이 1차 검증).

Usage:
  .venv/bin/python3 scripts/eval/closed_loop_eval_lstm_areadelta.py
"""
import sys
import json
...
def main():
    ...
    out_path = ROOT / "docs/v5/closed_loop_eval/lstm_comparison_areadelta.json"
