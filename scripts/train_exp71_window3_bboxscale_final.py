#!/usr/bin/env python3
"""
2026-07-07: 배포용 최종 체크포인트 학습 — window=3, bbox_scale=3.0 (오늘 확인된
...
OUT_DIR = Path("runs/v5_nav/mlp/exp71_window3_bboxscale3")
OUT_DIR.mkdir(parents=True, exist_ok=True)
OUT_CKPT = OUT_DIR / "action_transformer.pt"
OUT_LOG = Path("docs/v5/closed_loop_eval/exp71_window3_bboxscale3_final.json")
