...
- [ ] 트랙C(오버슈트→재수렴, 64ep) 물리 수집 — minum exp73 결과 확인 후 우선순위 판단
- [x] **트랙F(center 위치, 45ep, §1-2 참고) 물리 수집 완료 — 2026-07-16.**
      cx_position에 `center`(cx 0.475~0.525) 추가 후 동일 3경로 × 15회 전량 수집,
      soda→minum 전송 완료. V6가 5위치×3경로=225ep로 완결됨(트랙C 64ep만 남음).
