...
CACHE = Path("docs/v5/closed_loop_eval/exp71_vis_cache_colorfixed.pt")
OUT_DIR = Path("runs/v5_nav/mlp/exp71_window6_bboxscale3_colorfixed")
OUT_DIR.mkdir(parents=True, exist_ok=True)
OUT_CKPT = OUT_DIR / "action_transformer.pt"
OUT_LOG = Path("docs/v5/closed_loop_eval/exp71_window6_bboxscale3_colorfixed_final.json")
...
def main():
    ...
    torch.save({
        ...
        "source": "pg448",
        "exp": "exp71_window6_bboxscale3_colorfixed",
        "head": "transformer",
        "window": WINDOW,
