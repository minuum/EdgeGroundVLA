...
ax1.plot(epochs, train_loss, "o-", color="#38bdf8", label="train loss", linewidth=3, markersize=9)
ax1.plot(epochs, val_loss, "o-", color="#f87171", label="val loss", linewidth=3, markersize=9)
ax1.set_xlabel("epoch", fontsize=30, fontweight="bold")
ax1.set_ylabel("Loss", fontsize=30, fontweight="bold")
ax1.set_title("image_proj Stage 1 — train/val loss", fontsize=22, fontweight="bold")
...
ax2.plot(epochs, val_acc, "o-", color="#22c55e", linewidth=3, markersize=9, label="epoch별 val_acc")
ax2.axhline(final_acc, color="#f87171", linestyle="--", linewidth=2, label=f"최종 {final_acc:.2f}%")
ax2.set_xlabel("epoch", fontsize=30, fontweight="bold")
ax2.set_ylabel("Accuracy (%)", fontsize=30, fontweight="bold")
ax2.set_title("image_proj Stage 1 — validation accuracy", fontsize=22, fontweight="bold")
