...
> 작성: 2026-06-24 · 갱신: 2026-06-25 · 상태: **완료 — n=737로 표본 확장, "도움 안 됨" 확정. §1 운영 코드 반영 안 함**
> 결과: research_story.html CH51(51-1~51-4) 참고. 3개 독립 소스(저장된 세션 n=2, 재그라운딩 세션
> n=16, V5 학습 에피소드 시작 n=719) 모두 같은 방향 — 줌 재시도 후 area가 89%(656/737) 프레임에서
> 오히려 작아짐, has_bbox False→True 전환 0건. CH50의 다운스트림(closed-loop) 결론과 그라운딩 raw
> 레벨에서 교차검증됨. 운영 코드 반영하지 않음(확정).
