#!/usr/bin/env python3
"""
grounding_skip_n=3 시뮬레이션 데이터로 LSTM-none(area_delta 없는 baseline)을
재평가 — skip3_replace_areadelta와 비교할 대조군.

Usage:
  .venv/bin/python3 scripts/eval/closed_loop_eval_skip3_baseline.py
"""
import sys
import json
...
def main():
    ...
    out_path = ROOT / "docs/v5/closed_loop_eval/lstm_comparison_skip3_baseline.json"
