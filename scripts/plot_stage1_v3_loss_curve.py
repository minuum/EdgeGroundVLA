...
ax1.set_title("image_proj Stage 1 — train/val loss", fontsize=15)
...
ax2.set_ylabel("val 정확도 (%)", fontsize=16, fontweight="bold")
ax2.set_title("image_proj Stage 1 — val accuracy", fontsize=15)
ax2.tick_params(axis="both", labelsize=13)
ax2.legend(fontsize=13, loc="lower right")
ax2.grid(True, alpha=0.3)

fig.suptitle("image_proj Stage 1 재학습 — loss는 계속 감소, val_acc와 함께 수렴 (과적합 징후 없음)", fontsize=13)
fig.tight_layout()
